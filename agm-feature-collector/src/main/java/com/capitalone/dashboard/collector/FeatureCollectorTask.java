...
public class FeatureCollectorTask extends CollectorTask<FeatureCollector> {
	...
	private final AgmDataFactoryImpl agmConnection;
	...
	public FeatureCollectorTask(TaskScheduler taskScheduler,
			...
			FeatureSettings featureSettings,AgmDataFactoryImpl agmConnection) {
		super(taskScheduler, "Agm");
		...
		this.agmConnection = connectToPersistentClient();
	}
	...
	public void collect(FeatureCollector collector) {
		...
		TeamDataClientImpl teamData = new TeamDataClientImpl(
				...
				this.teamRepository, this.agmConnection);
		...
		ProjectDataClientImpl projectData = new ProjectDataClientImpl(
				...
				this.featureCollectorRepository, this.agmConnection);
        ...
        //TODO: this may have to be modified as AgmDataFactoryImpl is changed for Agm
	private AgmDataFactoryImpl connectToPersistentClient() {
		return new AgmDataFactoryImpl();
	}
}
