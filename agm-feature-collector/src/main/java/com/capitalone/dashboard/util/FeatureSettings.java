...
public class FeatureSettings {
	...
	private String agmProxyUrl;
	private String agmBaseUri;
	private String agmAccessToken;
        private int workspace;
        private String agmClientId;
        private String agmSecret;
    ...
    public String getAgmClientId() {
        return agmClientId;
    }

    public void setAgmClientId(String agmClientId) {
        this.agmClientId = agmClientId;
    }

    public String getAgmSecret() {
        return agmSecret;
    }

    public void setAgmSecret(String agmSecret) {
	...
	public String getAgmProxyUrl() {
		return this.agmProxyUrl;
	}

	public String getAgmBaseUri() {
		return this.agmBaseUri;
	}

	public String getAgmAccessToken() {
		return this.agmAccessToken;
	}

	public void setAgmProxyUrl(String versionOneProxyUrl) {
		this.agmProxyUrl = versionOneProxyUrl;
	}

	public void setAgmBaseUri(String versionOneBaseUri) {
		this.agmBaseUri = versionOneBaseUri;
	}

	public void setAgmAccessToken(String versionOneAccessToken) {
		this.agmAccessToken = versionOneAccessToken;
	}
}
